...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thuý Loan - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0359172019</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thuý Loan - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0359172019</div>", unsafe_allow_html=True)
